...
Логика 1-в-1 с n8n (текущее поведение, без «доизобретения» флагов брошенности):
  ...
  2. Оставляем «целевые»: Оборот>30, кол-во сотрудников>5, есть сделка в воронке «Первая линия» (8733326).
...
OBOROT_GT = 30                   # порог по обороту (ЦА: оборот больше этого значения)
